      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
        <div className="grid gap-5 md:grid-cols-2">
          <div className="md:col-span-2">
            <label className="mb-1 block text-sm font-medium text-primary-light">Campaign title</label>
            <input
          ...
          <div className="md:col-span-2">
            <label className="mb-1 block text-sm font-medium text-primary-light">Campaign story</label>
            <textarea
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-primary-light">Category</label>
            <select
              value={form.category}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-primary-light">Deadline</label>
            <input
              type="date"
              value={form.deadline}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-primary-light">Funding goal (credits)</label>
            <input
              type="number"
              min="0"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-primary-light">
          ...
          <div className="md:col-span-2">
            <label className="mb-1 block text-sm font-medium text-primary-light">Reward info</label>
            <textarea
          ...
          <div className="md:col-span-2">
            <label className="mb-1 block text-sm font-medium text-primary-light">Campaign image</label>
            <input
              type="file"
              accept="image/*"
            ...
            {uploading ? <p className="mt-2 text-sm text-primary-light">Uploading image...</p> : null}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-t border-zinc-100 pt-6">
          <p className="text-sm text-zinc-500">
            Campaigns are saved with a <span className="font-medium text-primary-light">pending</span> status
            until approved by an admin.
          </p>
          <button
            type="submit"
            disabled={loading || uploading}
            className="rounded-lg bg-primary px-6 py-2.5 font-medium text-white transition hover:bg-primary-light disabled:cursor-not-allowed disabled:opacity-70"
          >
